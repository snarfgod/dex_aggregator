          ...
          <Form onSubmit={swapHandler} style={{ maxWidth: '450px', margin: '50px auto' }}>
            ...
            <Row className='my-3'>
              ...
              <InputGroup>
                ...
                >
                  <Dropdown.Item onClick={(e) => setInputToken(e.target.innerHTML)} >SNRF</Dropdown.Item>
            ...
            <Row className='my-4'>
              ...
              <InputGroup>
                ...
                >
                  <Dropdown.Item onClick={(e) => setOutputToken(e.target.innerHTML)}>SNRF</Dropdown.Item>
